        ...
        <Grid item container direction='column' lg style={{ maxWidth: '40em' }}>
          ...
          <Grid item>
            ...
            >
              ...
              completely altered every aspect of human life. This has increase
            ...
            >
              ...
              unlimated potential by using it to solve problems and better lives
            ...
            >
              ...
              building it, and we want to hepl guide the world into this next
            ...
            <Typography
              ...
              gutterBottom
            >
              We see a future where every individual has personalixed software
              custome tailored to their lifstyle, culture, and interests,
        ...
        <Grid item container direction='column' lg style={{ maxWidth: '40em' }}>
          ...
          <Grid item>
            ...
            >
              ...
              traditional websites, React websites are built wiht little chunks
            ...
            <Typography
              ...
              gutterBottom
            >
              This technology is now being ued by companies liek AirBnB,
            ...
            >
              ...
              project setup and devployment, allowing creators to focuse as much
              as possible on their work isself.
            </Typography>
            <Typography
              align={matchesMD ? 'center' : undefined}
              variant='body1'
              gutterBottom
            >
              These techical advancements translate into savings by
              significantly reducing the workload and streamlining the workflow
              for developing ne pieces of software, while also lowerign the
        ...
        >
          ...
          <Grid item>
            ...
            >
              ...
              while taking care to identigy other potential areas for
              consideration.
            </Typography>
            <Typography
              style={{ color: '#fff', maxWidth: '20em' }}
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            ...
            width='100%'
            style={{ maxWidth: 700, maxWidth: '40em' }}
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            ...
            alt='paintbrush leaving stroke of pink'
            width='100%'
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            ...
            alt='rocket'
            width='100%'
            style={{ maxWidth: matchesMD ? 120 : 200 }}
          />
        </Grid>
      </Grid>
      <Grid
