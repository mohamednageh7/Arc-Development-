...
const Websites = ({ setSelectedIndex, setValue }) => {
  ...
  return (
    <Grid container direction='column'>
      <Head>
        <title key='title'>Stunning Website Design | Arc Development</title>
        <meta
          name='description'
          key='description'
          content='Completely custome designed and built from scratch to be blazing fast. Optimized code, server-side rendering, and perfect responsive desing | 99% PageSpeed Score'
        />
        <meta
          property='og:title'
        ...
        <Grid item container direction='column' className={classes.heading}>
          ...
          <Grid item>
            ...
            >
              ...
              online drives growth and enable you to reach new customers.
            </Typography>
          </Grid>
        </Grid>
        <Hidden mdDown>
      ...
      >
        ...
        <Grid item className={classes.paragraphContainer}>
          ...
          >
            ...
            empowering you to make smarter descisions wiht measurable effects.
          </Typography>
        </Grid>
      </Grid>
      <Grid
          ...
          <Grid container direction='column'>
            ...
            <Grid item>
              <img
                ...
                alt='world outline made of dollar signe'
              />
            </Grid>
          </Grid>
        </Grid>
      ...
      >
        ...
        >
          ...
          >
            ...
            online is a great way to help customers deside what's right for them
